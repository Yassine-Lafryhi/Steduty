...
<footer class="site-footer" role="contentinfo">
    ...
    <div class="wrapper wrapper-copy">
        ...
        <p class="copy-ilovewp"><span class="theme-credit">Powered by <a
                        href="https://github.com/Yassine-Lafryhi/Steduty" class="footer-logo-ilovewp"
                        style="text-decoration:  none; font-size: 16px;">Steduty</a></span></p>
    </div>
</footer>
</div>
<?php wp_footer(); ?>
